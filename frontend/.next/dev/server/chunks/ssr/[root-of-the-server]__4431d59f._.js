...
;
/** ---- Config ---- */ const API_URL = process.env.NEXT_PUBLIC_API_URL || "http://localhost:8080";
const API_TIMEOUT = Number(process.env.NEXT_PUBLIC_API_TIMEOUT) || 5000;
/** ---- Axios instance ---- */ const api = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: API_URL,
    timeout: API_TIMEOUT,
    headers: {
...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["register"])(name, email, password);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4431d59f._.js.map