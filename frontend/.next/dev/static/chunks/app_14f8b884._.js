...
;
/** ---- Config ---- */ const API_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || "http://localhost:8080";
const API_TIMEOUT = Number(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_TIMEOUT) || 5000;
/** ---- Axios instance ---- */ const api = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: API_URL,
    timeout: API_TIMEOUT,
    headers: {
...
/** Utility: safely set Authorization header for Axios v1 */ function setAuthHeader(headers, token) {
    if (!headers) {
        return {
...
/** ---- Interceptors ---- */ // Attach JWT if present
...
//# sourceMappingURL=app_14f8b884._.js.map